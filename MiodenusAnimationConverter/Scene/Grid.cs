...
using Cameras;
using Shaders;
using Shaders.FragmentShaders;
using Shaders.VertexShaders;
using NLog;
...
public class Grid
{
    ...
    public Grid(Vector3 position, Color4 xyPlaneColor, Color4 xzPlaneColor, Color4 yzPlaneColor, int xSizeInCells = 0,
            int ySizeInCells = 0, int zSizeInCells = 0, float cellSize = 1.0f, float lineWidth = 1.0f) :
            this(new Pivot(position, lineWidth + 1.0f, xSizeInCells * cellSize / 2.0f,
            ySizeInCells * cellSize / 2.0f, zSizeInCells * cellSize / 2.0f), xyPlaneColor, xzPlaneColor,
            yzPlaneColor, xSizeInCells, ySizeInCells, zSizeInCells, cellSize, lineWidth) {}
    ...
    public Grid(in Pivot pivot, Color4 xyPlaneColor, Color4 xzPlaneColor, Color4 yzPlaneColor, int xSizeInCells = 0,
            int ySizeInCells = 0, int zSizeInCells = 0, float cellSize = 1.0f, float lineWidth = 1.0f)
    {
