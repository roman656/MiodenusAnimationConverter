...
public static class Program
{
    ...
    private static void Run(in ParserResult<CommandLineOptions> result)
    {
    ...
    private static void DisplayHelp(in ParserResult<CommandLineOptions> result, in IEnumerable<Error> errs)
    {
